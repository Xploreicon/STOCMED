...
export const localSaleSchema = z.object({
  ...
  manual_discount: money.optional(),
  loyalty_points_redeemed: z.coerce.number().int().nonnegative().optional(),
  loyalty_points_earned: z.coerce.number().int().nonnegative().optional(),
  loyalty_discount: money.optional(),
  staff_id: uuid.optional(),
  staff_session_token: z.string().min(32).optional(),
  shift_id: uuid,
  subtotal: money,
  discount: money,
  total: money,
  payment_method: z.enum(['cash', 'bank_transfer', 'pharmacy_pos_terminal', 'credit', 'other']),
  ...
  credit_authorization_token: z.string().min(32).optional(),
